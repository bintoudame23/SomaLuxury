...
export default function PanierPage() {
  ...
  const zones = {
    "Zones Parcelles Assainies / Libertés": {
      quartiers: ["Parcelles Assainies", "Soprim", "Grand Medine", "Grand Yoff", "Cambérène", "Golf-sud"],
      tarif: 2000,
    },
    Guediawaye: {
      quartiers: ["Golf Nord", "Cité Enseignant", "Ndiarème-Limamoulaye", "Wakhinane Nimzatt", "Sam Notaire", "Médina-Gounass"],
      tarif: 2500,
    },
    Pikine: {
    ...
    "Zones Centre-ville": {
      quartiers: ["Médina", "Colobane", "Fass", "Liberté 1", "Liberté 2", "Liberté 3", "Liberté 4", "Liberté 5", "HLM Plateau", "Grand Dakar", "Point E", "Fann", "Mermoz"],
      tarif: 3000,
    },
    "Zone éloignée": {
      quartiers: ["Rufisque Centre", "Thiaroye", "Sangalkam", "Bargny", "Jaxaay", "Grand Mbao", "Mbao", "Keur Massar", "Keur Mbaye Fall"],
      tarif: 5000,
    },
  };
              ...
              <>
                ...
                <form onSubmit={handleSubmit} className="mt-8 space-y-4">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    {(["prenom", "name", "email", "adresse", "numero"] as const).map((field) => (
                      <div key={field}>
